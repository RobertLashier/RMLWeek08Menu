...
class Menu {
  ...
  viewShoppingCart() {
    ...
    for (let i = 0; i < this.items.length; i++) {
      // new variable to concatenate array elements for display
      itemString += i + ") " + this.items[i].item + "\n";
    }
  ...
  addItem() {
    // declare variable for prompt for customer input
